#ifndef VOXA_ACOUSTIC_MODEL_HPP
#define VOXA_ACOUSTIC_MODEL_HPP
...
class VoxaAcousticModel {
public:
    VoxaAcousticModel(const std::string& modelPath, int numThreads = 4);
    ~VoxaAcousticModel();
