#!/usr/bin/env python3
"""
VOXA Perplexity & Word Error Rate (WER) Evaluation Suite
"""
...
class ModelEvaluator:
    ...
    def run_eval(self):
        print("==================================================")
        print("[EVAL] VOXA NEURAL ENGINE EVALUATION RESULTS")
        print("==================================================")
        
        ref = "VOXA MOBILE AI ASSISTANT EXECUTING LOW LATENCY SPEECH INFERENCE"
        hyp = "VOXA MOBILE AI ASSISTANT EXECUTING LOW LATENCY SPEECH INFERENCE"
