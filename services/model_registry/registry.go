...
func NewModelRegistry() *ModelRegistry {
	...
	r.models["conformer-asr-v1"] = &ModelArtifact{
		...
		SizeBytes:   65685,
		UploadedAt:  time.Now(),
		DownloadURL: "https://models.voxa.app/onnx/voxa_conformer_asr_v1.onnx",
	}
	r.models["llama-3-8b-int4"] = &ModelArtifact{
		...
		SizeBytes:   91312,
		UploadedAt:  time.Now(),
		DownloadURL: "https://models.voxa.app/gguf/voxa_llama_3_int4.gguf",
	}
	return r
}
...
func main() {
	...
	port := ":9094"
	log.Printf("⚡ VOXA Go Model Registry listening on %s...", port)
