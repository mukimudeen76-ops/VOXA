package com.voxa.assistant.network;

import android.util.Log;
import java.nio.ByteBuffer;
import java.util.concurrent.atomic.AtomicBoolean;

public class VoxaBinaryWebSocketClient {
    private static final String TAG = "VoxaBinaryWebSocketClient";

    private final String mServerUri;
    private final AtomicBoolean mIsConnected;
    private long mBytesTransmitted;

    public VoxaBinaryWebSocketClient(String serverUri) {
