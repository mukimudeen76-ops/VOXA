...
class VoxaAcousticStreamer {
    ...
    fun startStreaming(onAudioChunkProcessed: (FloatArray, Float) -> Unit) {
        ...
        try {
            ...
            Log.i(TAG, "VoxaAcousticStreamer recording started with buffer size: $bufferSize")
    ...
    fun stopStreaming() {
        ...
        try {
            ...
            audioRecord?.release()
            audioRecord = null
            Log.i(TAG, "VoxaAcousticStreamer stopped")
        } catch (e: Exception) {
    ...
    companion object {
        private const val TAG = "VoxaAcousticStreamer"
    }
}
