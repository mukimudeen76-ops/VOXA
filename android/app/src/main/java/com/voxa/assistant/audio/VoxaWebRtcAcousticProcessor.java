 ...
 */
public class VoxaWebRtcAcousticProcessor {
    private static final String TAG = "VoxaWebRtcAcousticProcessor";
    ...
    public VoxaWebRtcAcousticProcessor(int sampleRate, int channels) {
