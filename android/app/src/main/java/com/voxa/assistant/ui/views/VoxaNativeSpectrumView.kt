package com.voxa.assistant.ui.views

import android.content.Context
import android.graphics.*
import android.util.AttributeSet
import android.view.View
import com.voxa.assistant.core.AudioSpectrumFrame
...
class VoxaNativeSpectrumView @JvmOverloads constructor(
    context: Context,
    ...
    private fun startDataSubscription() {
        viewScope.launch {
            VoxaNativeEngine.spectrumFlow.collectLatest { frame ->
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawText("VOXA KOTLIN DSP SPECTRUM • COHERENCE: ${(quantumCoherence * 100).toInt()}%", 30f, 50f, textPaint)
    }
