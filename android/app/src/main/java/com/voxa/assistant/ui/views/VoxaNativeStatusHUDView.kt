...
import com.voxa.assistant.core.NativeTelemetryData
import kotlinx.coroutines.*
import kotlinx.coroutines.flow.collectLatest
import java.util.Locale

class VoxaNativeStatusHUDView @JvmOverloads constructor(
    context: Context,
    ...
    private fun startTelemetrySubscription() {
        viewScope.launch {
            VoxaNativeEngine.telemetryFlow.collectLatest { data ->
                telemetryData = data
                invalidate()
            }
        }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        // Title Header
        canvas.drawText("⚡ VOXA KOTLIN / C++ CORE ENGINE", padding + 25f, padding + 55f, titlePaint)
