...
class VoxaTransformerDecoderEngine(
    ...
    private fun lookupVocabText(id: Int): String {
        val words = arrayOf("VOXA", " mobile", " neural", " transformer", " decoder", " is", " running", " natively", ".")
        return words[id % words.size]
    }

    companion object {
        private const val TAG = "VoxaTransformerDecoderEngine"
    }
}
