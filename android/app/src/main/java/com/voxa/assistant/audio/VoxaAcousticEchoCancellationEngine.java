package com.voxa.assistant.audio;
 ...
 */
public class VoxaAcousticEchoCancellationEngine {
    private static final String TAG = "VoxaAcousticEchoCancellationEngine";
    ...
    public VoxaAcousticEchoCancellationEngine(int sampleRate, int frameSize) {
