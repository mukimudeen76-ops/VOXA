package com.voxa.assistant.security;
...
public class VoxaZeroTrustKeyStore {
    private static final String TAG = "VoxaZeroTrustKeyStore";
    private static final String KEY_ALIAS = "VOXA_MASTER_VOICE_KEY";
    private static final String ANDROID_KEYSTORE = "AndroidKeyStore";

    public VoxaZeroTrustKeyStore() {
        try {
            initMasterKey();
        } catch (Exception e) {
