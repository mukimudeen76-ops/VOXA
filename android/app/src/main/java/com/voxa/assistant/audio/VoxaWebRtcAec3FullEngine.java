...
public class VoxaWebRtcAec3FullEngine {
    private static final String TAG = "VoxaWebRtcAec3FullEngine";

    private final int mSampleRate;
    private final int mChannels;
    private float[] mAdaptiveFilterWeights;

    public VoxaWebRtcAec3FullEngine(int sampleRate, int channels) {
