...
void testFFTProcessing() {
    voxa::core::VoxaCoreEngine engine;
    ...
    voxa::core::SignalFrame frame = engine.processAudioBuffer(samples, 512);
...
void testSimdDotProduct() {
    ...
    float dot = voxa::simd::VoxaSimdMatrixAccelerator::dotProductSimd(a, b, 4);
